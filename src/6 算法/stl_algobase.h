...
/*
 * @brief 针对类的operator()方便偏特化，因为函数模板不支持偏特化
 */
template <class InputIterator, class OutputIterator>
...
/*
 * @brief copy针对const char *的特化，直接使用mommove启动
 */
...
/*
 * @brief 找到第一个使得binar_pred为false的位置
 */
